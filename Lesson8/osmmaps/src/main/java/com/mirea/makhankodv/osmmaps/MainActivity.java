...
import com.mirea.makhankodv.osmmaps.databinding.ActivityMainBinding;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void funcAll(){
        ...
        setMarker("Останкинская башня", new GeoPoint(55.819722, 37.611690));
        setMarker("Поклонная гора", new GeoPoint(55.731749, 37.506903));
        setMarker("Стадион лужники", new GeoPoint(55.715688, 37.553607));
    }
}